...
class VendingMachine:
    ...
    def restock(self, n):
        ...
        """
        self.count += n
        return 'Current ' + self.product_name +' stock: ' + str(self.count)
    ...
    def vend(self):
        ...
        if self.amount < self.price:
            price_to_add = self.price - self.amount
            return 'Please add $' + str(price_to_add) + ' more funds.'

        dis = self.amount - self.price
        self.amount = 0
        self.count -= 1
        res = 'Here is your ' + self.product_name
        ad = ' and $'+ str(dis) + ' change.' if dis > 0 else '.'
        return res + ad
